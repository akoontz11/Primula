...
plot(c(Dgen) ~ Dgeo[lower.tri(Dgeo)], 
     ...
     main = "Genetic by Geographic distance (using adegenet)")
...
# From Will: for color-coding individual points, this should take the matrix and return matching populations
# It might be helpful to look at how this correlation maps WITHIN clusters
outer(pop.name, pop.name, identical)
